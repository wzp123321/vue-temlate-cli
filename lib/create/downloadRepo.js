...
import { loadingUtils, userCheckUtils, downloadGitRepo } from '../utils/index';
/**
 * 执行创建命令
...
const execCreate = async (projectType, projectName) => {
    ...
    switch (projectType) {
        case 'vue':
            loadingUtils('正在下载模板，请稍后...', () => downloadGitRepo('wzp123321/vue-vite-template', path.join(process.cwd(), projectName)), { projectName });
            break;
        case 'library':
        case 'react':
        case 'uniapp':
